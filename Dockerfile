...
CMD ["source activate wps && exec climafwps start -b 0.0.0.0 -c /opt/wps/etc/demo.cfg"]

# docker build -t cp4cds/climaf-wps-demo .
# docker run -p 5000:5000 cp4cds/climaf-wps-demo
